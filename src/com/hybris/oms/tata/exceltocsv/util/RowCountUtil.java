...
public class RowCountUtil {
	 ...
	 * @return
	 */
	public static int determineRowCount(final XSSFSheet sheet){
		int lastRowIndex = -1;
	 ...
	 * @return
	 */
	public static String getCellValue(final Row row, final int columnIndex){
	 ...
	 * @return
	 */
	public static int findSurfaceModeIndex(final XSSFSheet sheet, final String cellContent){
